...
- 将部分项目显示文案调整为更偏“大学副本地图”风格，更适合截图传播和小红书分享
- 保持 30 个项目的顺序不变，继续兼容基于数组索引的 `localStorage` 本地存档
- 同步更新 `TAG_RULES` 和 `MAP_AREAS` 中的项目引用，确保人格标签、副本地图、已制霸摘要、复制分享文案和下载分享图正常工作

## v0.4 更新

- 新增“大学副本地图 / 校园通关路线图”区域，位于分享结果卡片和项目列表之间
- 将 30 个项目拆分为 5 个副本区域，实时显示区域完成率和状态
- 分享结果卡片新增“最强副本区域”
- 复制分享文案新增“最强副本”字段
...
- 30 个大学生活项目打卡
- 项目文案采用更偏“大学副本”风格的任务命名，但不改变核心玩法和存档顺序
- 每个项目支持 0-4 五个等级
- 自动计算当前总分、最大总分、制霸率和称号
- 顶部结果区域适合截图分享
- 新增大学副本地图，展示 5 个区域的路线节点、完成率、状态和项目列表
- 支持复制分享文案
- 支持下载分享图 PNG
- 支持重置所有选择
